jQuery(function($){
    ...
    $.supersized({
        ...
        slides             : [    // Slideshow Images
								 {image : '/Template/xiao/Home/Public/images/bgimg/'+"bg"+(Math.floor(Math.random()*5))+".jpg"},

                                 {image : '/Template/xiao/Home/Public/images/bgimg/bg1.jpg'},
                                 {image : '/images/bg2.jpg'},
                                 {image : '/Template/xiao/Home/Public/images/bgimg/bg3.jpg'},
								 {image : '/Template/xiao/Home/Public/images/bgimg/bg4.jpg'}
                             ]
