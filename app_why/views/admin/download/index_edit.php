<!--主题框架开始-->
<?php $this->_cdata['_title']="编辑资源－".$this->_cdata['_title'];?>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal jzr-form" role="form" onsubmit="return settingpwd_check(this)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" value="<?=$download['title']?>"  class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="kwd" value="<?=$download['kwd']?>"  class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 image">
                            ...
                            <div class="img-show ace-thumbnails">
                                <img width="64px;" height="64px" data-action="zoom" src="<?=$download['icon']?>" alt="" style="cursor:zoom-in;">
                                <input name="download_icon" value="<?=$download['icon']?>" type="hidden">
                            </div>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="is_hot" class="ace ace-switch ace-switch-4" type="checkbox" <?php if($download['is_hot']){?>checked="checked"<?php }?> />
                            <span class="lbl"></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" name="download_res" value="<?=$download['durl']?>" id="download_res"/>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="lurl" value="<?=$download['lurl']?>"  class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <script id="container" name="content" type="text/plain"><?=$download['content']?></script>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function settingpwd_check(forms){
        $.ajax({
            type : "POST",
            url : "/admin/download/index_edit?id=<?=$download['id']?>",
            dataType : "json",
            async : true,
            data:{
