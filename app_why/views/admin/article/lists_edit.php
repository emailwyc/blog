<!--主题框架开始-->
<?php $this->_cdata['_title']="编辑文章－".$this->_cdata['_title'];?>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal jzr-form" role="form" onsubmit="return settingpwd_check(this)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" value="<?=$art['title']?>"  class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 image">
                            ...
                            <div class="img-show ace-thumbnails">
                                <img width="64px;" height="64px" data-action="zoom" src="<?=$art['img']?>" alt="" style="cursor:zoom-in;">
                                <input name="article_icon" value="<?=$art['img']?>" type="hidden">
                            </div>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="is_reward" class="ace ace-switch ace-switch-4" type="checkbox" <?php if($art['is_reward']){?>checked="checked"<?php }?> />
                            <span class="lbl"></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="is_hot" class="ace ace-switch ace-switch-4" type="checkbox" <?php if($art['is_hot']){?>checked="checked"<?php }?> />
                            <span class="lbl"></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="status" class="ace ace-switch ace-switch-4" type="checkbox" <?php if($art['status']){?>checked="checked"<?php }?>/>
                            <span class="lbl"></span>
                        </div>
                    </div>
                    <div class="space-4"></div>
                        ...
                        <div class="col-sm-9">
                            <select name="cid" aria-controls="sample-table-2">
                                <?php foreach ($artClass as $v):?>
                                    <option value="<?=$v['id']?>" <?php if($art['cid']==$v['id']){ echo "selected='selected'";}?>><?=$v['name']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9" style="vertical-align: middle!important;">
                            <?php foreach ($tags as $v):?>
                                <input name="tags" type="checkbox"  <?php if(in_array($v['id'],$atags)){ echo "checked='checked'";}?> value="<?=$v['id']?>"><?=$v['name']?>&nbsp;
                            <?php endforeach;?>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea name="short" class="form-control" placeholder="请用简短的话描述一下吧"><?=$art['short']?></textarea>
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function settingpwd_check(forms){
        $.ajax({
            type : "POST",
            url : "/admin/article/lists_edit?id=<?=$art['id']?>",
            dataType : "json",
            async : true,
            data:{
