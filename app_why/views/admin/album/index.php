<!--主题框架开始-->
<?php $this->_cdata['_title']="相册列表－".$this->_cdata['_title'];?>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="table-header">
                            共<span style="color:yellow;" class="allcount"><?=$albumClass['page']['count']?></span>条数据
                        </div>
                        <div class="table-responsive">
                            <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
                                ...
                                <div class="row" style="padding:5px;">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="dataTables_filter" id="sample-table-2_filter">
                                            <label>
                                                <a href="/admin/album/index_add"><button class="btn btn-sm btn-warning">添加相册</button></a>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php foreach ($albumClass['data'] as $k=>$v):?>
                                        <tr class="delMark<?=$v['id'];?>">
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="green" href="/admin/album/index_edit?id=<?=$v['id']?>">
                ...
                <script type="text/javascript">
                    ...
                    jQuery('#paginate').pagination(<?=$albumClass['page']['count']?>,{
                        current_page:<?=$albumClass['page']['curpage']?>,
                        items_per_page:<?=$albumClass['page']['per']?>,
                        link_to:"/admin/album/index/__id__"
                    });
                </script>
                <!--page-->
