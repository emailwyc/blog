jQuery(function($){
    ...
    $.supersized({
        ...
        slides             : [    // Slideshow Images
								 {image : '/ui/system/images/'+"bg"+(Math.floor(Math.random()*5))+".jpg"},
								 {image : '/ui/system/images/bg0.jpg'},
                                 {image : '/ui/system/images/bg1.jpg'},
                                 {image : '/ui/system/images/bg2.jpg'},
                                 {image : '/ui/system/images/bg3.jpg'},
								 {image : '/ui/system/images/bg4.jpg'}
                             ]
