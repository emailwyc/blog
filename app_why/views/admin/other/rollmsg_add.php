<!--主题框架开始-->
<?php $this->_cdata['_title']="发表消息－".$this->_cdata['_title'];?>
            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal jzr-form" role="form" onsubmit="return settingpwd_check(this)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="message" value=""  class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    <div class="space-4"></div>
                    <div class="space-4"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <input class="form-control date-picker" id="id-date-picker-1" name="starttime" type="text" data-date-format="yyyy-mm-dd" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group input-group-sm">
                                <input class="form-control date-picker" id="id-date-picker-2" name="endtime" type="text" data-date-format="yyyy-mm-dd" />
                                <span class="input-group-addon"><i class="icon-calendar bigger-110"></i></span>
                            </div>
                        </div>
                    </div>
